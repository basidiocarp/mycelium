...
fn extract_imports(content: &str, lang: &Language) -> Vec<String> {
    let re = match lang {
        Language::Rust => import_rust(),
        Language::Python => import_python(),
        Language::JavaScript | Language::TypeScript => import_js_ts(),
        Language::Go => import_go(),
        _ => return Vec::new(),
    };
...
fn extract_functions(content: &str, lang: &Language) -> Vec<String> {
    let re = match lang {
        Language::Rust => func_rust(),
        Language::Python => func_python(),
        Language::JavaScript | Language::TypeScript => func_js_ts(),
        Language::Go => func_go(),
        _ => return Vec::new(),
    };
...
fn extract_structs(content: &str, lang: &Language) -> Vec<String> {
    let re = match lang {
        Language::Rust => struct_rust(),
        Language::Python => struct_python(),
        Language::TypeScript => struct_ts(),
        Language::Go => struct_go(),
        Language::Java => struct_java(),
        _ => return Vec::new(),
    };
...
fn extract_traits(content: &str, lang: &Language) -> Vec<String> {
    let re = match lang {
        Language::Rust => trait_rust(),
        Language::TypeScript => trait_ts(),
        _ => return Vec::new(),
    };
