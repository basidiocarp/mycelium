...
//!
//! Provides common helpers used across mycelium commands:
...
/// # Examples
/// ```
/// use mycelium::utils::strip_ansi;
/// let colored = "\x1b[31mError\x1b[0m";
/// assert_eq!(strip_ansi(colored), "Error");
/// ```
pub fn strip_ansi(text: &str) -> String {
    strip_ansi_escapes::strip_str(text).to_string()
}
...
/// # Examples
/// ```no_run
/// use mycelium::utils::execute_command;
...
/// # Examples
/// ```
/// use mycelium::utils::format_tokens;
...
/// # Examples
/// ```
/// use mycelium::utils::join_with_overflow;
...
/// # Examples
/// ```
/// use mycelium::utils::truncate_iso_date;
...
/// # Examples
/// ```
/// use mycelium::utils::ok_confirmation;
...
/// Returns "pnpm", "bun", "yarn", or "npm" based on lockfile presence.
///
/// # Examples
/// ```no_run
/// use mycelium::utils::detect_package_manager;
...
mod tests {
    ...
    fn test_detect_package_manager_default() {
        // In the test environment (mycelium repo), there's no JS lockfile
        // so it should default to "npm"
        let pm = detect_package_manager();
        assert!(["pnpm", "bun", "yarn", "npm"].contains(&pm));
    }
