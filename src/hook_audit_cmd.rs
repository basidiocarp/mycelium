...
mod tests {
    ...
    fn test_parse_line_rewrite() {
        ...
        assert_eq!(entry._rewritten_cmd, "mycelium git status");
    }
    ...
    fn test_token_savings() {
        // Simulate what mycelium hook-audit would output vs raw log dump
        let raw_log = r#"2026-02-16T14:30:01Z | rewrite | git status | mycelium git status
2026-02-16T14:30:02Z | skip:no_match | echo hello | -
2026-02-16T14:30:03Z | rewrite | cargo test | mycelium cargo test
2026-02-16T14:30:04Z | skip:already_mycelium | mycelium git log | -
2026-02-16T14:30:05Z | rewrite | git log --oneline -10 | mycelium git log --oneline -10
2026-02-16T14:30:06Z | rewrite | gh pr view 42 | mycelium gh pr view 42
2026-02-16T14:30:07Z | skip:no_match | mkdir -p foo | -
2026-02-16T14:30:08Z | rewrite | cargo clippy --all-targets | mycelium cargo clippy --all-targets"#;
