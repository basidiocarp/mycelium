//! Compact `wc` filter that strips redundant paths and alignment padding.
use crate::tracking;
use anyhow::{Context, Result};
use std::process::Command;

/// Execute `wc` and format output with compact column labels and path shortening.
