//! Auto-detecting formatter proxy for Prettier, Black, Ruff, and Biome.
use crate::js::prettier as prettier_cmd;
...
/// Run an auto-detected or explicit formatter (Prettier, Black, Ruff, Biome) with compact output.
pub fn run(args: &[String], verbose: u8) -> Result<()> {
    ...
    timer.track(
        ...
        &format!("mycelium format {} {}", formatter, user_args.join(" ")),
        &raw,
        &filtered,
    );
