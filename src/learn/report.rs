...
/// Write correction rules to a Markdown file grouped by base command.
pub fn write_rules_file(rules: &[CorrectionRule], path: &str) -> Result<()> {
    ...
    content.push_str("# CLI Corrections (auto-generated by mycelium learn)\n");
    content.push_str("# Run `mycelium learn --write-rules` to update\n\n");
